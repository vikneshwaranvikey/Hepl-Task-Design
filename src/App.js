      ...
      <div className="flex h-screen bg-blue-50 w-screen">
        ...
        <div className={`md:block ${click ? "block" : "hidden"} w-72 bg-gray-800`} >
          ...
          <div className="flex items-center justify-center">
            <button className="flex items-center bg-orange-600 p-2 h-14 w-60 rounded-md font-medium text-white text-base"><img className="w-1/12 mx-4" src={pnd} alt="Your SVG" />Master Records</button>
          </div>
        </div>
        {/*Sidebar End*/}
        ...
        <div className="w-9/12 mx-auto mt-8">
          ...
          <div className="lg:flex justify-between mt-16" >
            <div className="relative">
              ...
              <input type="text" className="bg-white h-14 w-96 px-12 rounded-lg outline-none focus:shadow-lg hover:cursor-pointer font-bold" placeholder="Search any Keyword" />
            </div>
