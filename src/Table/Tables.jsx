...
function Tables(props) {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (record) => (
                <Space size="middle">
                    <a href='icon'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-orange-300 fill-orange-400">
    ...
    return (
        <div ><Table className=' font-bold' columns={columns} style={{ fontSize: "bold" }} dataSource={dataSource} /></div>
    )
}
